...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index('ix_embeddingcluster_cluster_id', 'embeddingcluster', ['cluster_id'])
    op.create_index('ix_embeddingcluster_clustering_result_id', 'embeddingcluster', ['clustering_result_id'])
    op.create_index('ix_embeddingcluster_embedding_id', 'embeddingcluster', ['embedding_id'])

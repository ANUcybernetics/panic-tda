...
def upgrade() -> None:
    ...
    op.add_column('clusteringresult', sa.Column('started_at', sa.DateTime(), nullable=True))
    op.add_column('clusteringresult', sa.Column('completed_at', sa.DateTime(), nullable=True))

defmodule PanicTda.Models.GenAI do
  ...
  @real_t2i_models ~w(SD35Medium ZImageTurbo Flux2Klein Flux2Dev GLMImage)
  @real_i2t_models ~w(Moondream3 Qwen25VL Gemma3n Gemma4 Pixtral LLaMA32Vision Qwen3VL JoyCaption)
